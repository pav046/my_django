    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('count_m', models.IntegerField(blank=True, default=0)),
            ],
        ),
        migrations.CreateModel(
            name='TagPost',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(max_length=255, unique=True, verbose_name='Slug')),
                ('photo', models.ImageField(blank=True, default=None, null=True, upload_to='photo/%Y/%m/%d', verbose_name='Фотография')),
                ...
                ('my_tags', models.ManyToManyField(blank=True, related_name='your_tags', to='women.tagpost', verbose_name='Тэги')),
            ],
            options={
